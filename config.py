...
# Webhook настройки (продакшн)
WEBHOOK_URL = os.getenv('WEBHOOK_URL', 'https://pixelpieai.ru/webhook')
...
# === НАСТРОЙКА YOOKASSA ===
YOOKASSA_ENABLED = bool(YOOKASSA_SHOP_ID and SECRET_KEY)

if YOOKASSA_SHOP_ID and SECRET_KEY:
    try:
...
TARIFFS = {
    ...
    "тест": {
        ...
        "avatars": 0,
        "videos": 0,
        "display": "🧪 10₽ за 3 Печеньки (ТЕСТ)",
        "callback": "pay_10",
        "description": "Тестовый тариф для проверки платежей",
        "dev_only": True
    },
    "admin_premium": {
        "name": "🔧 Admin Test",
...
__all__ = [
    ...
    'YOOKASSA_SHOP_ID', 'SECRET_KEY', 'YOOKASSA_RETURN_URL', 'YOOKASSA_ENABLED',
