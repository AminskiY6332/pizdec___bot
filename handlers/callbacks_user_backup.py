...
from database import (
    ...
    get_user_data, update_user_data, log_user_action, get_user_resources,
    decrement_user_resources, check_user_subscription, get_user_avatar_data,
    get_user_trained_models, get_user_avatar_by_id, get_user_avatar_count,
    get_user_generation_count, get_user_rating, get_user_referral_data,
    get_user_referral_count, get_user_referral_earnings, get_user_referral_link,
    get_user_referral_users, get_user_referral_users_count, get_user_referral_users_earnings,
    get_user_referral_users_earnings_count, get_user_referral_users_earnings_total,
    get_user_referral_users_earnings_total_count, get_user_referral_users_earnings_total_sum,
    get_user_referral_users_earnings_total_sum_count, get_user_referral_users_earnings_total_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_count, get_user_referral_users_earnings_total_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_count, get_user_referral_users_earnings_total_sum_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_sum_count, get_user_referral_users_earnings_total_sum_sum_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum, get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_count, get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_count, get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_count, get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_count, get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_count, get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_count, get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_count, get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_count, get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_count, get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_count, get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_count, get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_count, get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_count, get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_count, get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_count, get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_count, get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_count, get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_count, get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_count, get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_count, get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum_sum,
    get_user_referral_users_earnings_total_sum_sum_sum_sum_sum_sum_sum_run_terminal_cmd
)
...
async def handle_generate_with_avatar_callback(query: CallbackQuery, state: FSMContext) -> None:
    ...
    try:
        ...
        if user_cache is not None:
            ...
            logger.debug(f"Кеш недоступен для user_id={target_user_id}")
...
async def handle_confirm_assisted_prompt_callback(query: CallbackQuery, state: FSMContext) -> None:
    ...
    try:
        ...
        if generation_type == 'ai_video_v2_1':
            ...
            # Не отправляем дублирующее сообщение "🎯 Генерирую...",
            # так как оно будет отправлено в generation/images.py
            # Это предотвращает дублирование сообщений пользователю
            await ask_for_aspect_ratio_callback(query, state)
...
async def handle_subscribe_callback(query: CallbackQuery, state: FSMContext, user_id: int) -> None:
    ...
    if is_paying_user or is_old_user_flag or (days_since_registration >= 5 and last_reminder_type == "reminder_day5"):
        ...
        tariff_key = None  # Инициализируем переменную
        ...
        # Добавляем кнопку только если tariff_key определен
    ...
    try:
        ...
        if not is_paying_user:
            ...
            if not show_all_tariffs:
                # Определяем рекомендуемый тариф, но не блокируем другие
                recommended_tariff = None
                if days_since_registration == 0:
                    if time_since_registration <= 1800:  # До 30 минут
                        recommended_tariff = "комфорт"
                    elif time_since_registration <= 5400:  # 30–90 минут
                        recommended_tariff = "лайт"
                    else:  # После 90 минут
                        recommended_tariff = "мини"
                elif days_since_registration == 1:
                    recommended_tariff = "лайт"
                elif days_since_registration <= 4:
                    recommended_tariff = "мини"

                # Логируем рекомендацию, но не блокируем выбор
                if recommended_tariff and tariff_key != recommended_tariff:
                    logger.info(f"Пользователь user_id={user_id} выбрал тариф {tariff_key}, рекомендуется {recommended_tariff} на день {days_since_registration}")
                    # Не блокируем выбор, только логируем
        ...
        if email:
            ...
            from config import YOOKASSA_SHOP_ID, SECRET_KEY
            ...
            try:
                bot_username = (await query.bot.get_me()).username
                payment_url, payment_id = await create_payment_link(user_id, email, amount, description, bot_username)
